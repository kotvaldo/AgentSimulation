...
//meta! id="432"
public class ProcesPoSkladani extends Process
{
	public ProcesPoSkladani(int id, Simulation mySim, CommonAgent myAgent)
	{
	...
	//meta! sender="AgentCinnosti", id="433", type="Start"
	public void processStart(MessageForm message)
	{
		...
		double newTime = simulation.getGenerators().getProcessAfterAssemblyDist().sample();
