...
public class ManagerPracovnikov extends OSPABA.Manager
{
	...
	public void processUvolniPracovnikaA(MessageForm message)
	{
	}
	...
	public void processUvolniPracovnikaB(MessageForm message)
	{
	}
	...
	public void processMessage(MessageForm message)
	{
		...
		case Mc.uvolniPracovnikaB:
			processUvolniPracovnikaB(message);
		break;
		...
		case Mc.uvolniPracovnikaA:
			processUvolniPracovnikaA(message);
		break;
