...
public class ManagerSkladu extends OSPABA.Manager
{
	...
	//meta! sender="AgentNabytku", id="133", type="Notice"
	public void processZaciatokPripravy(MessageForm message)
	{
	}

	//meta! sender="Priprava", id="129", type="Finish"
	...
	public void processMessage(MessageForm message)
	{
		switch (message.code())
		{
		case Mc.zaciatokPripravy:
			processZaciatokPripravy(message);
		break;
