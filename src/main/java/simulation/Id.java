...
public class Id extends OSPABA.IdList
{
	...
	public static final int agentSkladu = 19;
	public static final int agentPracovisk = 15;
	...
	public static final int priprava = 1011;
	public static final int procesPripravaVSklade = 1029;
	public static final int zmenaStavuPracovnehoMiesta = 1007;
	public static final int prichodObjednavky = 1030;
	public static final int procesRezania = 1024;
	public static final int presunNaPracovisko = 1009;
	public static final int procesLakovania = 1025;
	public static final int presunDoSkladu = 1010;
	public static final int procesMorenia = 1026;
	public static final int procesMontaze = 1027;
	public static final int procesSkladania = 1028;
	public static final int assigniPracovneMiesto = 1022;
	//meta! tag="end"
}
